...
namespace Services
{
    public interface ISenderService
    {
        ...
        Task<PagedResult<Sender>> GetAllAsync(int? page, int? pageSize, string orderBy, CancellationToken cancellationToken);
        Task<List<SenderDTO>> GetAsync(CancellationToken cancellationToken);
    }
}
